#ifndef GEMECONSOLEWINDOW_H
#define GEMECONSOLEWINDOW_H
...
private:
    ...
    void OutputText(CEGUI::String inMsg,                       // Post the message to the ChatHistory listbox.
                    CEGUI::Colour colour = CEGUI::Colour( 0xFF00FF00)); //   with a white color default

    CEGUI::Window *m_ConsoleWindow;                            // This will be a pointer to the ConsoleRoot window.
    std::string sNamePrefix;                                  // This will be the prefix name we give the layout
    static int iInstanceNumber;                                 // This will be the instance number for this class.
    bool m_bConsole;
};

#endif // GEMECONSOLEWINDOW_H
